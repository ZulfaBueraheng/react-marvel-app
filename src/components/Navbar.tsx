          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-3 flex items-baseline space-x-2">
                  <Link
                    to="/"
                    className="text-white hover:bg-red-800 px-3 py-2 rounded-md text-base font-medium"
                  >
                    Home
                  </Link>
                  <Link
            ...
            <div className="mr-2 flex md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-white hover:bg-red-800 focus:outline"
